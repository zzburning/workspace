...
int check_msg(msg_t *msg, msg_t **associate_msg_list);
int save_msg(msg_t *msg);


typedef struct msg_strc
{
	char *tags;
	char *msg;
	char *subject;
	char *verb;
	char *object;
	msg_t **associate_msgs;
}msg_t;

#define  MODNAME	"knowlege"
#define MAX_MSG_CNT	10
#define MAX_CONF	20

/*get equipment boot time and now time*/
#define HX_G_STAT_EQ_UPTIME	5000	
/*get equipment harddisk active infomations*/
#define HX_G_STAT_EQ_HARDDISK	5001	
